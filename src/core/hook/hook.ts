...
export type HookStage = 
    'onContext' | 'onDevServerStart' | 'onStart' | 'onBeforePage' | 'onAfterPage' | 'onFinish'
...
export const loadProjectHooks = (context: Context) => {
    ...
    console.log('Found project hooks.', hookFiles.map(hookFilePath => toProjectRootRelativePath(hookFilePath, context.config)))
