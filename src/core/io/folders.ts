...
export const isGlobPath = (path: string) =>
    path.indexOf('*') > -1 || path.indexOf('{') > -1

export const isDynamicRoutingPath = (path: string) => 
    path.indexOf('[') > -1 && path.indexOf(']') > -1 


export const copyModuleToDistAndBundleForBrowser = async(context: Context, moduleName: string, entryPointPath: string) => 
