...
export const getStyleSheetHoisted = (path: string, type: ResultLanguageType, lang: SourceLanguageType, context: Context) => 
    loadAndTranspileCode(path, type, lang, 'hoist', context)
...
globalThis.resolvePathRelative = resolvePathRelative
